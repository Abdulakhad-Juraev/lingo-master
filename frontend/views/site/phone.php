...
isset($title) ? $this->title = $title : $this->title = "Ro'yhatdan o'tish";
?>
                ...
                <div class="container">
                    ...
                    <div id="show-login" class="from-top wrapper">
                        ...
                        <div class="signup signup-heading">
                            <h2><?= $title ?? "Ro'yhatdan o'tish uchun" ?></h2>
                        ...
                        <div class="signup signup-submit">
                            <?= Html::submitButton('Yuborish', ['class' => 'signup signup-submit', 'name' => 'login-button']) ?>
                        </div>
                        ...
                        <div class=" signup login-notif">
                            Allaqachon ro'yhardan o'tganmisiz? <span class="show-hide"><a
