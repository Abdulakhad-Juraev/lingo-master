...
<div class="card">
    <div class="card-body">
        <?= $form->field($model, 'value')->widget(CKEditorForDynamicForm::className(), ['editorOptions' => $ckeditorOptions, 'options' => ['autofocus' => true, 'tabindex' => 1]])->label('Question') ?>
        <?= $form->field($model, 'type_id')->dropDownList(IeltsQuestions::types()) ?>
    </div>
</div>
<hr>
<h5 align="center" class="text-muted bg-warning"><?= t('Ielts Reading Options') ?></h5>
<hr>
<div class="card">
    <div class="card-body">
                ...
                <div class="col-md-6 item">
                    <div class="">
                        ...
                        <div class="radio-area">
                            <?= Html::radio('is_correct', $modelOption->is_correct, ['label' => "To'g'ri javob", 'value' => $index, 'class' => "radio-selection", 'title' => "Ushbu variantni to'g'ri javob sifatida belgilash"]) ?>
                        </div>
