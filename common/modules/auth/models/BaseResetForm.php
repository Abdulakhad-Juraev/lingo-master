 ...
 */
abstract class BaseResetForm extends SoftModel
{
    /**
...
//            ['phone', 'match', 'pattern' => '/\+998\(\d{2}\) \d{3}\-\d{2}\-\d{2}/', 'message' => t('Incorrect phone number')],
    ...
    {
//        return 7777;
//        return YII_DEBUG ? 7777 : mt_rand(1000, 9999);
...
//        return true;
    ...
    public function resetPassword()
    {
        ...
        $currentDevice->device_token = $this->device_token;
        ...
        $transaction->commit();
        return $this->resetSuccessResponse($user, $currentDevice);
     ...
     * @return mixed
     */
    abstract public function resetSuccessResponse(User $user, UserDevice $device);
